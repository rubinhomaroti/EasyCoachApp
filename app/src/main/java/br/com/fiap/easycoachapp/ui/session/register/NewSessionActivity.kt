...
class NewSessionActivity: AppCompatActivity(), NewSessionContract {
    ...
    private fun setupView() {
        ...
        spCoachee.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
        ...
        spSpecialities.onItemSelectedListener = object : AdapterView.OnItemSelectedListener{
            override fun onNothingSelected(parent: AdapterView<*>?) { }
